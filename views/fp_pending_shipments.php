<?php require_once("includes/fp_header.php"); ?>
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <form action="<?= base_url();?>contraceptive_pending_shipments/show_pending_shipments" method="post" enctype="multipart/form-data" autocomplete="on">
                        ...
                        <?php if(isset($pending_shipment_successfully_retrieved)){?>  <!--CHECK IF DATA IS THERE-->
                            ...
                            <?php foreach ($PSTOCKS as $pending_stocks): ?>
                                ...
                                <tr>
                                    ...
                                    <td><a href="<?php echo(base_url()."contraceptive_pending_shipments/delete_pending_shipment/".$pending_stocks->pending_shipment_id); ?>"><i class="fa fa-trash"></i></a></td>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content animated bounceInRight">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form action="<?= base_url();?>index.php/contraceptive_pending_shipments/update_pending_shipment_id" method="post" name="Pendingshipment" onsubmit="return validatePendingshipment() enctype="multipart/form-data" autocomplete="on">
        ...
        <div class="modal-dialog">
            <div class="modal-content animated bounceInRight">
                ...
                <div class="modal-body">
                    ...
                    <form action="<?= base_url();?>index.php/contraceptive_pending_shipments/save_pending_shipment" method="post"  id="form" name="Pendingshipment" onsubmit="return validatePendingshipment() enctype="multipart/form-data" autocomplete="on">
