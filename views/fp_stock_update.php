<?php require_once("includes/fp_header.php"); ?>
  ...
  <div class="row">
    <div class="col-lg-3">
    <form class="form" method="post" action="<?php echo(base_url()); ?>contraceptive_update_stocks/show_current_stock">
...
<tbody>
                ...
                <div class="modal-content animated bounceInRight">
                    ...
                    <form action="<?= base_url();?>contraceptive_update_stocks/update_current_stock" method="post" enctype="multipart/form-data">  
      ...
      <td> <a href="<?php echo(base_url()."contraceptive_update_stocks/delete_data/".$central_level_data->current_stock_id); ?>"><i class="fa fa-trash"></i></a>    
</td>
      </tr>
      <?php $count++; 
      endforeach; ?>
...
<div class="modal inmodal" id="central_level_data" tabindex="-1" role="dialog" aria-hidden="true">
                ...
                <div class="modal-content animated bounceInRight">
                    ...
                    <form action="<?= base_url();?>contraceptive_update_stocks/save_current_data" method="post" enctype="multipart/form-data">  
                    <div class="modal-body">
