                            ...
                            <tbody>
                               ...
                               <div class="modal-dialog">
                                    <div class="modal-content animated bounceInRight">
                                        ...
                                        <form action="<?= base_url();?>contraceptive_funding_agency/update_funding_agency" method="post" enctype="multipart/form-data">  
        ...
        <div class="modal inmodal" id="add_funding_agency" tabindex="-1" role="dialog" aria-hidden="true">
                               <div class="modal-dialog">
                                    <div class="modal-content animated bounceInRight">
                                        ...
                                        <form action="<?= base_url();?>contraceptive_funding_agency/save_funding_agency" method="post" enctype="multipart/form-data">  
                                        <div class="modal-body">
