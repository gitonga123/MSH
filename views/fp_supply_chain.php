                        ...
                        <table class="table table-striped">
                            ...
                            <?php foreach ($agencies as $agency): ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo(base_url() . "contraceptive_supply_chain/delete_supply_chain_agency/" . $agency->supply_chain_agency_id); ?>"><i
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content animated bounceInRight">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form
                                                        action="<?= base_url(); ?>index.php/contraceptive_supply_chain/update_agency_id1"
        ...
        <div class="modal-dialog">
            <div class="modal-content animated bounceInRight">
                ...
                <div class="modal-body">
                    ...
                    <form action="<?= base_url(); ?>index.php/contraceptive_supply_chain/save_supply_chain_agency" method="post"
