...
<script>
  function myFunction() 
  {
     ...
     var url = base_url+"contraceptive_current_stock/get_by_id";
     $.getJSON
      (
        url,
    ...
    <div class="row">
    <div class="col-lg-3">
    <form class="form" method="post" action="<?php echo(base_url()); ?>contraceptive_current_stock/index">
...
<?php if (isset($period)) {?>
                ...
                <div class="modal-content animated bounceInRight">
                    ...
                    <form action="<?= base_url();?>contraceptive_current_stock/update_central_level" method="post" enctype="multipart/form-data">  
      ...
      <td> <a href="<?php echo(base_url()."contraceptive_current_stock/delete_central_level_data/".$central_level_data->central_level_stock_id); ?>"><i class="fa fa-trash"></i></a>    
</td>
      </tr>
...
<div class="modal inmodal" id="central_level_data" tabindex="-1" role="dialog" aria-hidden="true">
                ...
                <div class="modal-content animated bounceInRight">
                    ...
                    <form action="<?= base_url();?>contraceptive_current_stock/save_central_level" method="post" enctype="multipart/form-data">  
                    <div class="modal-body">
