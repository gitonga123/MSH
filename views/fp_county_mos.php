<?php require_once("includes/fp_header.php"); ?>
    ...
    <div class="wrapper wrapper-content">
        ...
        <div class="row">
            <div class="col-lg-3">
                <form class="form" method="post" action="<?php echo(base_url()); ?>contraceptive_report/county_mos">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>County months of stock chart</h5>
    ...
    $x_axis1=$x_axis1.(round(($p->physical_count) / ($p->adjusted_county_amc), 1)).",";
