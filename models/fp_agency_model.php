<?php 
class Fp_agency_model extends CI_Model{
	/*-----------------------------------Supply chain agency--------------------------------------------*/

	// Function To Fetch All Supply chain Agency Record

	function show_supply_chain_agencies(){
	$query = $this->db->get('contraceptive_supply_chain_agen');
	...
	$this->db->select('*');
	$this->db->from('contraceptive_supply_chain_agen');
	...
	function add_supply_chain_agency($agency=NULL){
		$this->db->insert('contraceptive_supply_chain_agencies', $agency);
	...
	function update_supply_chain_agencies_id1($id,$data){
	    ...
	    $this->db->update('contraceptive_supply_chain_agencies', $data);
	}
