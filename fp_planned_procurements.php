    ...
    <div class="wrapper wrapper-content">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
             ...
             <form action="<?= base_url();?>index.php/contraceptive_planned_procurements/show_planned_procurements_from_selected_planned_delivery_date" method="post" enctype="multipart/form-data" autocomplete="on">
...
<?php if(isset($planned_procurement_successfully_retrieved)){?>  <!--CHECK IF DATA IS THERE-->
    ...
    <?php foreach ($PSTOCKS as $planned_procurements): ?>
        ...
        <tr>
            ...
            <td><a href="<?php echo(base_url()."contraceptive_planned_procurements/delete_planned_procurement/".$planned_procurements->planned_procurement_id); ?>"><i class="fa fa-trash"></i></a></td>
                ...
                <div class="modal-dialog">
                    <div class="modal-content animated bounceInRight">
                        ...
                        <div class="modal-body">
                            ...
                            <form action="<?= base_url();?>index.php/contraceptive_planned_procurements/update_planned_procurement_id" method="post" enctype="multipart/form-data" autocomplete="on">
        ...
        <div class="modal-dialog">
            <div class="modal-content animated bounceInRight">
                ...
                <div class="modal-body">
                    ...
                    <form action="<?= base_url();?>index.php/contraceptive_planned_procurements/save_planned_procurement" method="post" enctype="multipart/form-data" autocomplete="on">
