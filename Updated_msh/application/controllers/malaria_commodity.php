...
class Malaria_commodity extends MY_Controller
{
    private $data;
    ...
    public function show_commodities() {
        $data['commodity'] = $this->malaria_commodity_model->show_commodities();
        $this->load->view('malaria_commodity',$data);
    ...
    function update_commodity() {
        ...
        $this->malaria_commodity_model->update_commodity($id,$data);
        $this->show_commodities();
    ...
    public function save_commodity(){
        ...
        $commodityId = $this->malaria_commodity_model->add_commodity($commodity);
        $this->show_commodities();
