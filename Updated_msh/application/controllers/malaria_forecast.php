...
class Malaria_forecast extends MY_Controller
{
    private $data;
	...
	function __construct()
    {
     ...
     $this->load->model("malaria_commodity_model");
      $this->load->model("malaria_forecast_model");
    }
    ...
    public function index($period="000000"){
      ...
      $forecast_data['dates']=$this->malaria_forecast_model->get_forecast_period();
      $forecast_data['selected_period']=$period;
        $forecast_data['period']=$this->malaria_forecast_model->show_commodity_forecast_data($period);
        $forecast_data['commodity']=$this->malaria_commodity_model->show_malaria_commodities();
    ...
    public function save_forecast_commodity_data()
    {
      ...
      $commodity_id=$this->malaria_forecast_model->get_commodity_id_with_the_given_name($commodity_name);
     ...
     $this->malaria_forecast_model->add_commodity_forecast_data($forecast);
    ...
    public function update_forecast_commodity_data()
    {
      ...
      $this->malaria_forecast_model->update_forecast_commodity_data($forecast_id, $forecast_update);
      $this->index($period="000000");
