...
class Lab_forecast extends MY_Controller
{
    private $data;
	...
	function __construct()
    {
     ...
     $this->load->model("lab_commodity_model");
      $this->load->model("lab_forecast_model");
    }
    ...
    public function index($period="000000"){
      ...
      $forecast_data['dates']=$this->lab_forecast_model->get_forecast_period();
      $forecast_data['selected_period']=$period;
        $forecast_data['period']=$this->lab_forecast_model->show_commodity_forecast_data($period);
        $forecast_data['commodity']=$this->lab_commodity_model->show_malaria_commodities();
    ...
    public function save_forecast_commodity_data()
    {
      ...
      $commodity_id=$this->lab_forecast_model->get_commodity_id_with_the_given_name($commodity_name);
     ...
     $this->lab_forecast_model->add_commodity_forecast_data($forecast);
    ...
    public function update_forecast_commodity_data()
    {
      ...
      $this->lab_forecast_model->update_forecast_commodity_data($forecast_id, $forecast_update);
      $this->index($period="000000");
