...
class Contraceptive_commodity extends MY_Controller
{
    private $data;
    ...
    public function show_commodities() {
        $data['commodity'] = $this->fp_commodity_model->show_commodities();
        $this->load->view('fp_commodity',$data);
    ...
    function update_commodity() {
        ...
        $this->fp_commodity_model->update_commodity($id,$data);
        $this->show_commodities();
    ...
    function delete_commodity($id)   {
        ...
        $deleterecord=$this->db->delete('contraceptive_commodities');
        $data['status'] =  "";
    ...
    public function save_commodity(){
        ...
        $commodityId = $this->fp_commodity_model->add_commodity($commodity);
        $this->show_commodities();
