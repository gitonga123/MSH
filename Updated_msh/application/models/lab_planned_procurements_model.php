<?php
class Lab_planned_procurements_model extends CI_Model
{



    function show_all_planned_lab_procurement()
    {


        $this->db->distinct();
        $this->db->group_by('planned_delivery_date');
        $query =$this->db->get('lab_planned_procurement_details');
    ...
    function show_planned_lab_procurement($planned_delivery_date)
    {


        $this->db->select('*');
        $this->db->from('lab_planned_procurement_details');
    ...
    function show_planned_lab_procurement_id($psdata)
    {
        $this->db->select('*');
        $this->db->from('lab_planned_procurement_details');
    ...
    function update_planned_lab_procurement($psid,$pendingdata)
    {
        $this->db->where('planned_procurement_id', $psid);
        $this->db->update('lab_planned_procurement_details', $pendingdata);
    }

    function add_planned_lab_procurement($pending = NULL)
    {
        $this->db->insert('lab_planned_procurement_details', $pending);
