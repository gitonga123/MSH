...
class Contraceptive_funding_agency extends MY_Controller
{
    private $data;
    ...
    {
        parent::__construct();
        $this->load->model('fp_agency_model');
    }
    ...
    public function show_funding_agency()
    {
        ...
        $data['funding_agency'] = $this->fp_agency_model->show_funding_orgs();
        //$data['single_funding_agency'] = $this->fp_agency_model->show_funding_org_id($funding_agency_id);
    ...
    function update_funding_agency() {
        ...
        $this->fp_agency_model->update_funding_agency($id,$data);
        $this->show_funding_agency();
    }
    ...
    public function save_funding_agency(){
        ...
        $fundingagencyId = $this->fp_agency_model->add_funding_agency($fagency);
        $this->show_funding_agency();
