...
<div class="row">
    <div class="col-lg-3">
    <form class="form" method="post" action="<?php echo(base_url()); ?>contraceptive_forecast/index">
        ...
        <div class="ibox-title">
             ...
             <div class="ibox-tools">
                ...
                <div class="ibox-content">
                            ...
                            <tr>
                                ...
                                <tbody>
                                    <?php if(!empty($period)) { foreach($period as $p):
                                     ...
                                     <td><a href="<?php echo(base_url()."contraceptive_forecast/delete_forecast/".$p->commodity_forecast_data_id); ?>"><i class="fa fa-trash"></i></a></td>
                  ...
                  <form action="<?= base_url();?>contraceptive_forecast/update_forecast_commodity_data" method="post" enctype="multipart/form-data" autocomplete="on">
 ...
 <div class="modal inmodal" id="save_forecast_commodity_data" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content animated bounceInRight">
                 ...
                 <form action="<?= base_url();?>contraceptive_forecast/save_forecast_commodity_data" method="post" enctype="multipart/form-data" autocomplete="on">
